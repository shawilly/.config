...
require('lazy').setup({
  ...
  { -- Autocompletion
    ...
    config = function()
      -- See `:help cmp`https://github.com/pmizio/typescript-tools.nvim
...

  {
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'typescript', 'javascript', 'python', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc' },
